...
const FORMAT_OPTIONS: FormatOption[] = [
  {
    ...
    description: "Adobe Premiere Pro project timeline",
    icon: Film,
    extension: "xml",
    category: "nle",
  },
  {
    ...
    description: "Final Cut Pro X project timeline",
    icon: Film,
    extension: "fcpxml",
    category: "nle",
  },
  {
    format: "edl",
    label: "EDL",
    description: "Edit Decision List — universal NLE format",
    icon: FileText,
    extension: "edl",
    category: "nle",
  },
  {
    format: "json",
    label: "JSON",
    description: "Full segment and blueprint data",
    icon: FileText,
    extension: "json",
    category: "data",
  },
  {
    ...
    description: "Segment data for spreadsheet analysis",
...
export default function ExportPage({
  ...
  const handleSendToPlugin = () => {
    ...
    try {
      ...
      client.send("project_update", {
        action: "timeline_import",
        projectId,
      });
      setPluginSent(true);
  ...
  return (
    <PageLayout
      title="Export"
      description="Download timeline files and project data"
    >
          ...
          <div className="flex items-start gap-3 rounded-lg border border-border bg-card p-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Import approved segments directly onto your Premiere Pro timeline via the EditorLens plugin
              </p>
            </div>
            <Button
              size="sm"
